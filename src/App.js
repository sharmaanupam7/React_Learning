      ...
      <Router>
        ...
        <div className="container my-3">
          <Routes>
            ...
            <Route exact path ="/" element = {<TextForm mode={mode} heading="Try TextUtils - Word Counter, Character Counter, Remove Extra Spaces" showAlert={showAlert}></TextForm>}></Route>
          </Routes>
        </div>
      </Router>
    </>
